...
INSERT INTO `Judgetable` (`FID`, `FName`, `FaName`, `Addrs`, `Gender`, `JDate`, `City`, `Pass`, `PhNo`) VALUES
...
(146891651, 'Martin', 'Hsuynh', 'Anthony Huynh', '3936  Brighton Circle Road', 'Male', 'MIT', '1996-08-05', 7023658960, 'password', 'martin@gmail.com'),
(146891652, 'June', 'Barker', 'Peter Barker', '4871  Romano Street', 'Female', 'BIT', '1996-02-10', 7410000010, 'password', 'barker@gmail.com'),
(146891663, 'Nurul', 'Ain', 'Salleh', 'Ipoh, Perak', 'Female', 'BIT', '2001-12-14', 7014445836, 'password', 'ain@gmail.com');
...
--
-- AUTO_INCREMENT for table `Judgetable`
--
ALTER TABLE `Judgetable`
